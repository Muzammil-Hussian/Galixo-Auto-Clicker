...
fun Context.getDefaultClickRepeatDelay(): Long =
    getConfigPreferences().getClickRepeatDelayConfig(100)

internal fun Context.getDefaultSwipeName(): String = getString(R.string.default_swipe_name)

fun Context.getDefaultSwipeDurationMs(): Long = getConfigPreferences().getSwipeDurationConfig(
    resources.getInteger(R.integer.default_swipe_duration).toLong()
)

internal fun Context.getDefaultSwipeRepeatCount(): Int =
    getConfigPreferences().getSwipeRepeatCountConfig(1)

fun Context.getDefaultSwipeRepeatDelay(): Long =
    getConfigPreferences().getSwipeRepeatDelayConfig(100)
